...
test('Valid NISS numbers', () => {
    ...
    expect(validateNISS('12992730412')).toBe(true);
});
...
test('invalid NIF numbers', () => {
    ...
    expect(validateNISS('32109072813')).toBe(false);  // invalid start
    expect(validateNISS('12109272813')).toBe(false);  // invalid middle
    expect(validateNISS('12109072810')).toBe(false);  // invalid end (CD)
});
